// Lista de países con su código telefónico (prefijo internacional).
// La bandera se deriva del código ISO en runtime (no se hardcodea).
...
export const COUNTRIES: Country[] = [
  ...
  { iso: 'MM', name: 'Myanmar (Birmania)', dial: '+95' },
  ...
  { iso: 'VA', name: 'Ciudad del Vaticano', dial: '+39' },
